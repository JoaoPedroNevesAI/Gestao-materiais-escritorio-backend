...
public class UsuarioService implements UserDetailsService {
    ...
    public Usuario save(Usuario usuario) {
        ...
        // Se o build() do Request funcionou, o tipo NÃO vai ser nulo e essa checagem é pulada!
    ...
    public Usuario update(Long id, Usuario novosDados) {
        ...
        if (!usuario.getEmail().equals(novosDados.getEmail()) && repository.findByEmail(novosDados.getEmail()).isPresent()) {
            throw new RegraNegocioException("Email já cadastrado");
        }

        if (novosDados.getCpf() != null && !novosDados.getCpf().equals(usuario.getCpf()) && repository.findByCpf(novosDados.getCpf()).isPresent()) {
            throw new RegraNegocioException("CPF já cadastrado");
        }
